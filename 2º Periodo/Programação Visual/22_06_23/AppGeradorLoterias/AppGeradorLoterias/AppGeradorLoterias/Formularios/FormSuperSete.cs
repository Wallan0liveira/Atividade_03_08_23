...
namespace AppGeradorLoterias.Formularios
{
    public partial class FormSuperSete : Form
    {
        ...
        private void Comparacao(int par, int impar)
        {
            ...
            if (impar == 3 && par == 4) { lbClass.Text = "MUITO ALTO!"; lbClass.ForeColor = Color.Green; }
            if (impar == 5 && par == 2) { lbClass.Text = "MÉDIO!"; lbClass.ForeColor = Color.Green; }
            if (impar == 2 && par == 5) { lbClass.Text = "MÉDIO!"; lbClass.ForeColor = Color.Green; }
            if (impar == 1 && par == 6) { lbClass.Text = "BAIXO!"; lbClass.ForeColor = Color.Orange; }
        ...
        public void GerarNumeros()
        {
            ...
            while (cont < 7)
            {
                numero = radNum.Next(0, 10);//números aleatórios
