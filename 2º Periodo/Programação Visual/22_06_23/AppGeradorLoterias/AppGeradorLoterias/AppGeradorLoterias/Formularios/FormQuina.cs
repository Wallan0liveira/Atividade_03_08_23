...
namespace AppGeradorLoterias.Formularios
{
    public partial class FormQuina : Form
    {
        ...
        private void Comparacao(int par, int impar)
        {
            ...
            if (impar == 3 && par == 2) { lbClass.Text = "ALTO!"; lbClass.ForeColor = Color.Green; }
            if (impar == 1 && par == 4) { lbClass.Text = "MÉDIO!"; lbClass.ForeColor = Color.Orange; }
            if (impar == 4 && par == 1) { lbClass.Text = "MÉDIO!"; lbClass.ForeColor = Color.Orange; }
            if (impar == 5 && par == 0) { lbClass.Text = "BAIXO!"; lbClass.ForeColor = Color.OrangeRed; }
            if (impar == 0 && impar == 5) { lbClass.Text = "MUITO BAIXO!"; lbClass.ForeColor = Color.Red; }
        ...
        public void GerarNumeros()
        {
            ...
            while (cont < 5)
            {
                numero = radNum.Next(1, 81);//números aleatórios
